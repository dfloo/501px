      ...
      >
        <div className="upload-modal-content">
          ...
          <Dropzone
            ...
            disableClick={true}
          >
            <h1 id="drag-drop-label" className="drag-drop-label">
          ...
          <form className="file-upload-form" onSubmit={this.handleSubmit}>
            <label
              htmlFor="file-input"
            ...
            <div id="input-pos-div" className="input-pos-div hidden">
              <label
              ...
              <label
                htmlFor="upload-description-input"
                className="upload-description-label"
              >
                Description
              </label>
              <textarea
            ...
            <div id="img-pos-div" className="img-pos-div hidden">
